...
export const MixedRatings: Story = {
  args: {
    ...
    testimonials: [
      {
        quote:
          "Excellent product with great features. Customer support is top-notch.",
        author: {
          name: "Lisa Chen",
      ...
      {
        quote:
          "Very good overall. A few minor issues but the team is working on them.",
        author: {
          name: "John Smith",
      ...
      {
        quote:
          "Solid product that gets the job done. Room for improvement in some areas.",
        author: {
          name: "Amanda White",
          title: "Project Lead",
        },
