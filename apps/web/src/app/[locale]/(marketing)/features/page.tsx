...
export async function generateMetadata(
  ...
  return await buildLocalizedMetadata({
    ...
    keywords: [
      ...
      'Next.js boilerplate capabilities',
    ],
  });
}
...
export default async function FeaturesPage(props: FeaturesPageProps) {
  ...
  const featureCards = [
    {
      title: t('grid_cards.auth.title'),
      description: t('grid_cards.auth.description'),
    },
    {
      title: t('grid_cards.database.title'),
      description: t('grid_cards.database.description'),
    },
    {
      title: t('grid_cards.security.title'),
      description: t('grid_cards.security.description'),
    },
    {
      title: t('grid_cards.seo.title'),
      description: t('grid_cards.seo.description'),
    },
    {
      title: t('grid_cards.monitoring.title'),
      description: t('grid_cards.monitoring.description'),
    },
    {
      title: t('grid_cards.tooling.title'),
      description: t('grid_cards.tooling.description'),
    },
  ];
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeWidth={2}
            d="M13 16h-1v-4h-1m1-4h.01M12 6.253c4.97 0 9 1.79 9 4v6c0 2.21-4.03 4-9 4s-9-1.79-9-4v-6c0-2.21 4.03-4 9-4z"
          />
        </svg>
      ),
  ...
  return (
    <>
      ...
      <div className="rounded-2xl bg-gray-50 p-6 text-center">
        ...
        <p className="mt-3 text-base text-gray-600">{t('hero_subtitle')}</p>
      </div>
