...
export default async function Index(props: IIndexProps) {
  ...
  return (
    <>
      ...
      <section
        id="highlights"
        className="mt-12 space-y-6 rounded-2xl bg-gray-50 p-6"
      >
        <h2 className="text-2xl font-bold">
          Build SEO-friendly, secure SaaS products with Next.js Boilerplate
        </h2>
        <p className="text-base text-gray-700">
          Every feature combines developer productivity with search performance.
          Metadata, hreflang tags, structured data, and JSON-LD helpers are
      ...
      >
        ...
        <p className="mt-2 text-sm text-gray-600">
          Ready-made pages showcase how the toolkit can power your marketing
          site and application experience.
        </p>
      ...
      <section
        id="cta"
        className="mt-12 rounded-2xl border border-blue-100 bg-blue-50 p-6 text-center"
      >
        <h2 className="text-2xl font-bold text-blue-900">
          Ready to launch faster?
        </h2>
        <p className="mt-2 text-blue-800">
          Clone the repository, choose your authentication provider, and deploy
          with production-ready SEO and monitoring.
        </p>
        <div className="mt-4 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link
            className="rounded-md border border-blue-200 px-6 py-3 font-semibold text-blue-900 hover:bg-blue-100"
            href={pricingHref}
          >
